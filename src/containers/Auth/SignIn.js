...
function SignIn() {
  ...
  const moveDashboard = () => {
    if (userName === 'bank' || userName === 'branch' || userName === 'merchant') {
      dispatch(setUserRole(userName));
    }
  ...
  return (
    <div className={classes.contentRoot}>
      ...
      <div className={classes.loginButton}>
        <Button fontSize="26px" radius="50px" width="400px" height="70px" onClick={moveDashboard}>
          {t('login')}
        </Button>
      </div>
